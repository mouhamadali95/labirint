...
w2 = GameSprite('platform2.png', 370, 210, 50, 400)

barriers.add(w1) 
barriers.add(w2) 

packman = Player('counter.png', 5, 420, 80, 80, 0, 0)

monster2 = Enemy('pngegg.png', win_width - 200, 400, 100, 100, 12) 
monsters.add(monster2) #

monster = Enemy('terrorist.png', win_width - 80, 180, 80, 80, 5) 
final_sprite = GameSprite('porte.png', win_width - 100, win_height - 100, 100, 100) 
